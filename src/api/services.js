...
export const usersApi = {
  ...
  removeRole: (id) => api.delete(`/roles/${id}`),
...
// PAYMENTS (queue -> execute -> vendor confirms -> order closed)
export const paymentsApi = {
  list: (params) => api.get('/payments', { params }),
  getOne: (id) => api.get(`/payments/${id}`),
  execute: (id, data) => api.post(`/payments/${id}/execute`, data),
};

// BILLING (sell item-master items, reduces inventory)
